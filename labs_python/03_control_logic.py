...
# Output:    
# Opcode 00 (LOAD) -> Hardwired {'MRD': 1, 'MWR': 0, 'RLD': 1, 'ALU_ADD': 0, 'ALU_SUB': 0} | PLA {'MRD': 1, 'MWR': 0, 'RLD': 1, 'ALU_ADD': 0, 'ALU_SUB': 0}
# Opcode 01 (STORE) -> Hardwired {'MRD': 0, 'MWR': 1, 'RLD': 0, 'ALU_ADD': 0, 'ALU_SUB': 0} | PLA {'MRD': 0, 'MWR': 1, 'RLD': 0, 'ALU_ADD': 0, 'ALU_SUB': 0}
# Opcode 10 (ADD) -> Hardwired {'MRD': 0, 'MWR': 0, 'RLD': 1, 'ALU_ADD': 1, 'ALU_SUB': 0} | PLA {'MRD': 0, 'MWR': 0, 'RLD': 1, 'ALU_ADD': 1, 'ALU_SUB': 0}
# Opcode 11 (SUB) -> Hardwired {'MRD': 0, 'MWR': 0, 'RLD': 1, 'ALU_ADD': 0, 'ALU_SUB': 1} | PLA {'MRD': 0, 'MWR': 0, 'RLD': 1, 'ALU_ADD': 0, 'ALU_SUB': 1}